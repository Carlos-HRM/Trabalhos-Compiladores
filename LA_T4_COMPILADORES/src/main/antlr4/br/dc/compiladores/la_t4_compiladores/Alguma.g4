...
// Tokens necessários para a geração do código C.
NUM_INT    : ('0'..'9')+ ;
...
// Regras principais levemente adaptadas para facilitar implementações.
...
declaracao_local    : declaracao_tipo | declaracao_var | declaracao_const ;
