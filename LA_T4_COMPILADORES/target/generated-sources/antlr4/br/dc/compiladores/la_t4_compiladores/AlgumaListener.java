...
public interface AlgumaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AlgumaParser#declaracao_var}.
	 * @param ctx the parse tree
	 */
	void enterDeclaracao_var(AlgumaParser.Declaracao_varContext ctx);
	/**
	 * Exit a parse tree produced by {@link AlgumaParser#declaracao_var}.
	 * @param ctx the parse tree
	 */
	void exitDeclaracao_var(AlgumaParser.Declaracao_varContext ctx);
	/**
	 * Enter a parse tree produced by {@link AlgumaParser#declaracao_const}.
	 * @param ctx the parse tree
	 */
	void enterDeclaracao_const(AlgumaParser.Declaracao_constContext ctx);
	/**
	 * Exit a parse tree produced by {@link AlgumaParser#declaracao_const}.
	 * @param ctx the parse tree
	 */
	void exitDeclaracao_const(AlgumaParser.Declaracao_constContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link AlgumaParser#op_logica_2}.
	 * @param ctx the parse tree
	 */
	void enterOp_logica_2(AlgumaParser.Op_logica_2Context ctx);
	/**
	 * Exit a parse tree produced by {@link AlgumaParser#op_logica_2}.
	 * @param ctx the parse tree
	 */
	void exitOp_logica_2(AlgumaParser.Op_logica_2Context ctx);
}