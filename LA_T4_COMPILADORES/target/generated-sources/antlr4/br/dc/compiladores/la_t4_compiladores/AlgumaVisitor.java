...
public interface AlgumaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AlgumaParser#declaracao_var}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaracao_var(AlgumaParser.Declaracao_varContext ctx);
	/**
	 * Visit a parse tree produced by {@link AlgumaParser#declaracao_const}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaracao_const(AlgumaParser.Declaracao_constContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link AlgumaParser#op_logica_2}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOp_logica_2(AlgumaParser.Op_logica_2Context ctx);
}